			...
			<div class="widget-content widget-content-area">
				...
				<div class="row">
						...
						<div class="row">
							<div class="col-xl-6 col-md-6 col-sm-6 col-12 mb-3"> 
								<div class="card bg-dark">
									<div class="card-body">
										<h5 class="card-text text-white text-center font-weight-bold">Códigos Postales</h5>
										<h2 class="text-white text-center font-weight-bold">{{ $zips }}</h2>
									</div>
								</div>
							</div>
							...
							<div class="col-xl-6 col-md-6 col-sm-6 col-12 mb-3"> 
								<div class="card bg-dark">
									<div class="card-body">
										<h5 class="card-text text-white text-center font-weight-bold">Colonias</h5>
										<h2 class="text-white text-center font-weight-bold">{{ $colonies }}</h2>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 col-12 mb-3"> 
						<div class="card bg-dark">
							<div class="card-body">
								<h5 class="card-text text-white text-center font-weight-bold">Secciones</h5>
								<h2 class="text-white text-center font-weight-bold">{{ $sections }}</h2>
							</div>
						</div>
					</div>
