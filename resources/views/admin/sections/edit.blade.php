			...
			<div class="widget-content widget-content-area">
				...
				<div class="row">
					<div class="col-12">
						...
						<form action="{{ route('secciones.update', ['slug' => $section->slug]) }}" method="POST" class="form" id="formSection">
							@csrf
							@method('PUT')
							<div class="row">
								<div class="form-group col-12">
									...
									<select class="form-control select2 @error('colony_id') is-invalid @enderror" name="colony_id[]" required multiple>
										...
										{!! selectArray($colonies, $section->colonies) !!}
									</select>
								</div>

								<div class="form-group col-12">
									<label class="col-form-label">Nombre<b class="text-danger">*</b></label>
									<input class="form-control int @error('name') is-invalid @enderror" type="text" name="name" required placeholder="Introduzca un nombre" value="{{ $section->name }}" maxlength="4" minlength="4">
								</div>

								<div class="form-group col-12">
									<div class="btn-group" role="group">
										<button type="submit" class="btn btn-primary" action="section">Actualizar</button>
